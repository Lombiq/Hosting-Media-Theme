...
namespace Lombiq.Hosting.MediaTheme.Middlewares;
...
public class MediaThemeAssetUrlRedirectMiddleware
{
        ...
        ISiteThemeService siteThemeService)
    {
        ...
        else
        {
            ...
            assetUrl = "/" + activeTheme.Id + assetPath.Replace(Paths.MediaThemeAssetsPath, string.Empty);
        }
